 ...
 * @since 4.0.0
 */
class DeveloperextensionsModel extends ListModel
{
    ...
    protected function getListQuery(): QueryInterface
    {
        ...
        $query->where('created_by.id = :id')->bind(':id', $currentUser->id, ParameterType::INTEGER);

        if (!$currentUser->authorise('core.edit', 'com_jed')) {
